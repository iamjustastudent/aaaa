...
result_running = True
running = True
start_text1 = M_font.render("Catch the food" , True, RED)
start_text2 = M_font.render("falling from the sky" , True, RED)
start_text3 = M_font.render("3 misses = over" , True, BLUE)
start_text4 = M_font.render("press any key to start" , True, BLUE)

screen.blit(start_text1, [20, size[1]/2-60])
screen.blit(start_text2, [20, size[1]/2-20])
screen.blit(start_text3, [20, size[1]/2+20])
screen.blit(start_text4, [20, size[1]/2+80])
...
if result_running == True:
    ...
    screen.blit(end_score_text, [30, size[1]/2-30])
    screen.blit(time_text, [30, size[1]/2+30])
